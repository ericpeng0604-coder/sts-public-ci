...
def main() -> None:
    ...
    try:
        ...
        raise AssertionError("Finesse midturn unexpectedly admitted without reconstruction aux")
    ...
    assert sorted(card.name for card in bc.discard_pile) == [
        "Bash", "Defend", "Defend", "Finesse", "Strike", "Strike"
    ]
    ...
    try:
        ...
        raise AssertionError("incomplete Finesse reconstruction aux unexpectedly admitted")
