...
def main() -> None:
    ...
    # Generate a genuinely reachable two-card midturn public state.  The source
    # BattleContext is used only to create the public observation; formal rebuild
    # below receives only that observation.
