...
def assess_public_finesse_player(
    ...
    *,
    ...
    # Reuse the already-audited Shrug structural gate for shared public fields.
    # The transformed copy is public-only validation scaffolding and never enters
    # Teacher policy state.
